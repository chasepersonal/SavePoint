...
namespace SavePoint.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            {
                // Different actions will be taken depending on the result of the users input
                ...
                {
                    // User will get warining if they failed to input the correct login information
        ...
        // Show information depending if E-mail was confirmed or not
        ...
        // Show Forgot Password Confirmation
        ...
        // Show Reset Password Requirements
